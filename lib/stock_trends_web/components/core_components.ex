defmodule StockTrendsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StockTrendsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StockTrendsWeb.Gettext, "errors", msg, opts)
    end
  end
